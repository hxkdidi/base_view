...
public class PullRecyclerView extends RecyclerView implements Pull, GestureDetector.OnGestureListener {
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        if (mOnScrollListener != null) {
            mOnScrollListener.setScrolling(Math.abs(velocityY) > 4000);
        }
        return false;
    }
