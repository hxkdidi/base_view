...
public class PullRefreshLayout extends RelativeLayout {
    ...
    private void initView() {
        ...
        refresh_progress = refreshView.findViewById(R.id.refresh_progress);
        refreshStateTextView = refreshView.findViewById(R.id.state_tv);
        // 初始化上拉布局
        load_foot = loadMoreView.findViewById(R.id.load_foot);
        tvNoMore = loadMoreView.findViewById(R.id.tvNoMore);
        linear = loadMoreView.findViewById(R.id.linear);
        load_progress = loadMoreView.findViewById(R.id.load_progress);
